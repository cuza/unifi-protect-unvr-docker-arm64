...
# This builds the UniFi Protect UNVR image from source to avoid distributing
# copyrighted UniFi content, then adds the Home Assistant addon wrapper.

# Build context is the repository root, so paths are relative to root

# Stage 1: Firmware Base
...
# Home Assistant Addon required labels
LABEL io.hass.version="5.8.3"
LABEL io.hass.type="addon"
LABEL io.hass.arch="aarch64"
LABEL io.hass.name="UniFi Protect UNVR"
LABEL io.hass.description="Run UniFi Protect UNVR in Docker on ARM64 hardware within Home Assistant"
